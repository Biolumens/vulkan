...
void Application::recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex)
{
	...
	// WE CAN DRAW NOW LETS FUCKING GOOOOOOOOOOOOOOOOOOOOO
...
{
	auto vertShaderCode = readFile("../../../shader/vertex.spv");
	auto fragShaderCode = readFile("../../../shader/fragment.spv");
	...
	vertexInputInfo.pVertexBindingDescriptions = &bindingDescription; // Vertex Buffer is hard coded in the shader
	vertexInputInfo.vertexAttributeDescriptionCount = static_cast<uint32_t>(attributeDescriptions.size());
	vertexInputInfo.pVertexAttributeDescriptions = attributeDescriptions.data(); // Vertex Buffer is hard coded in the shader
